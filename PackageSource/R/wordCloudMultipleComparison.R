...
#' 
wordCloudMultipleComparison <- function(conn=NULL,searchString){
  if (is.null(conn)) {
  ...
  text.corpus <- tm_map(text.corpus, removeWords, c('amp','yahoo','singapore',tableName,stopwords('en')))
